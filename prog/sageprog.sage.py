...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_20 = Integer(20); _sage_const_25 = Integer(25)# INTERSECTION_CONES_TOP_DIRECTORY = TODO
...
def block_truncate_raw_cones(p, n=None):
	...
	if os.path.isfile("../../Dropbox/UCLA/Research/current_quarter/IntersectionConeUtils/blocked_raw_cones/" + get_top_filename(
	 p, n, principal_core, -_sage_const_1 )):
		# print "\tSkipping."
		return
...
def induce_true_dec_mats_to(p, n=None, core=None, length=None):
	...
	if not os.path.isfile("../../Dropbox/UCLA/Research/current_quarter/IntersectionConeUtils/true_decomposition_matrices/" + 
	 get_top_filename(p, n-_sage_const_1 )):
...
def clean_up_files():
	for filename in sorted(os.listdir("../../Dropbox/UCLA/Research/current_quarter/IntersectionConeUtils/blocked_raw_cones/"),
	 key = get_pncorelength_from_filename):
		...
		r = eval(s)
		s = None
		if len(r.P_p) == _sage_const_0  or len(r.P_p[_sage_const_0 ]) <= _sage_const_1 :
			# Now cleanup.
...
def are_files_clean():
	count0 = _sage_const_0 
	count1 = _sage_const_0 
	countplus = _sage_const_0 
	for filename in sorted(os.listdir("../../Dropbox/UCLA/Research/current_quarter/IntersectionConeUtils/blocked_raw_cones/"),
	 key = get_pncorelength_from_filename):
		f = open("../../Dropbox/UCLA/Research/current_quarter/IntersectionConeUtils/blocked_raw_cones/" + filename, "r")
		s = f.read()
		...
		r = eval(s)
		s = None
		if len(r.P_p) == _sage_const_0 :
			count0 += _sage_const_1 
		elif len(r.P_p[_sage_const_0 ]) <= _sage_const_1 :
			count1 += _sage_const_1 
		else:
			countplus += _sage_const_1 
